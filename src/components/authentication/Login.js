...
const Login = () => {
  ...
  const [userName, setUsername] = useState(Config.GUEST_USERNAME);  // set the initial value of the username to the guest username from the config
  const [password, setPassword] = useState(Config.GUEST_PASSWORD);  // set the initial value of the password to the guest password from the config
